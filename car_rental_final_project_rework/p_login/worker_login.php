...
// If already logged in as worker → go to worker dashboard
...
<title>Worker Login - CarRent System</title>
...
<div class="login-container">
    <div class="login-header">
        ...
        <h1>CarRent Worker Portal</h1>
        <p>Worker Login - Limited Access</p>
    </div>
    ...
    <form method="POST" action="../processor/login_process.php">
        ...
        <button type="submit" style="background: #f5576c;">Login as Worker</button>
    </form>
